...
export class BaseRequest {
  ...
  /**
   * 包装 application_platform_id 到数据源中
   *
   * @param {object} dataSource 数据源
   */
  wrapApplicationPlatformIdToDataSource(dataSource: object) {
    return { ...dataSource, user_application_platform_id: this.getJwtUserClaims('application_platform_id') };
  }
